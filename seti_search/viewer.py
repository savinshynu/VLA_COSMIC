...
SETICORE_DIR = '/home/svarghes/seticore'
...
def plot_multiple(named_waterfalls):
    ...
    fig, axs = plt.subplots(rows, cols, figsize=(cols*4, rows*3), constrained_layout = True, dpi=300)
...
class Stamp(object):
    ...
    def show_antennas(self, outfile, save = True):
